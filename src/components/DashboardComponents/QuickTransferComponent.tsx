...
const users = [
    { name: 'Livia Bator', role: 'CEO', avatar: "/icons/contacts/Livia.png" },
    { name: 'Randy Press', role: 'Director', avatar: "/icons/contacts/Randy.png" },
    { name: 'Workman', role: 'Designer', avatar: "/icons/contacts/Workman.png" },
];
