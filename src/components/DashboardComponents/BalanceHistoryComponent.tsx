...
import LineChartGrafic from "../GraficComponents/LineChartGrafic";
...
const BalanceHistoryComponent = () => {
    const chartData = [100, 300, 250, 500, 450, 785, 300, 550, 250, 650, 600];
    ...
    return (
        <BalanceHistotyContainer>
            ...
            <BalanceHistoryGrafContainer>
                <LineChartGrafic key="line-chart" data={chartData} labels={chartLabels} />
            </BalanceHistoryGrafContainer>
        </BalanceHistotyContainer>
    );
};
