...
import insImage from '@/app/icons/service/insuarence.png';
import shoppImage from '@/app/icons/service/shopping.png';
import safeImage from '@/app/icons/service/safety.png';
...
const mainService = [
    { name: "Life Insurance", desc: "Unlimited protection", src: insImage.src },
    { name: "Shopping", desc: "Buy. Think. Grow.", src: shoppImage.src },
    { name: "Safety", desc: "We are your allies", src: safeImage.src }
];
