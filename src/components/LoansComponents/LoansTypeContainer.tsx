...
const loansTypes = [
  { name: "Personal Loans", amount: "$50,000", srcImg: "/icons/loans/types/personalloans.png" },
  { name: "Corporate Loans", amount: "$100,000", srcImg: "/icons/loans/types/corporateloans.png" },
  { name: "Business Loans", amount: "$500,000", srcImg: "/icons/loans/types/businessloans.png" },
  { name: "Custom Loans", amount: "Choose Money", srcImg: "/icons/loans/types/customloans.png" },
];
